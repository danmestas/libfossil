...
- **Deterministically testable.** Deterministic simulation testing (DST) with [BUGGIFY](./docs/testing.md#buggify) fault injection.
...
Full command list: `libfossil --help`. See [docs/migration-from-fossil.md](./docs/migration-from-fossil.md) for a command-by-command comparison with upstream Fossil.
...
Driver selection happens via blank import at link time. See [docs/extension-points.md](./docs/extension-points.md#sqlite-driver-interface) for the registration contract.
...
Both `SyncObserver` and `CheckoutObserver` are small interfaces you can implement directly. Details: [docs/extension-points.md](./docs/extension-points.md#observer-interfaces).
...
Test strategy — unit tests, dual-driver matrix, and deterministic simulation (DST) with BUGGIFY fault injection: [docs/testing.md](./docs/testing.md).

## Documentation

| Doc | Audience |
|-----|----------|
| [docs/architecture.md](./docs/architecture.md) | Contributors learning the codebase |
| [docs/testing.md](./docs/testing.md) | Contributors writing or debugging tests |
| [docs/extension-points.md](./docs/extension-points.md) | Consumers adding observers or custom drivers |
| [docs/migration-from-fossil.md](./docs/migration-from-fossil.md) | Users coming from upstream `fossil` |
